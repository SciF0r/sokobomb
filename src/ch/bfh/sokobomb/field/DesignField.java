 ...
 */
public class DesignField implements Cloneable, Field {

	private Stack<DesignField> fieldHistory = new Stack<DesignField>();
...
//		parser.parse(path, this);
	...
	public void undo() {
		if (!this.fieldHistory.isEmpty()) {
			DesignField field = this.fieldHistory.pop();
	...
	public void restartLevel() {
		if (!this.fieldHistory.isEmpty()) {
			DesignField field = this.fieldHistory.firstElement();
			this.bombs  = field.getBombs();
			this.player = field.getPlayer();
